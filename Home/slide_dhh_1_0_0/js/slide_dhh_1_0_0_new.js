let slider1 = [{
        title: 'Khuyến mãi',
        background: 'Home/slide_dhh_1_0_0/images/khuyen-mai.jpg',
        link: '#',
    },
    {
        title: 'Khuyến mãi 2',
...
let slider1mb = [{
        title: 'Khuyến mãi',
        background: 'Home/slide_dhh_1_0_0/images/khuyen-mai-m.jpg',
        link: '#',
    },
    {
        title: 'Khuyến mãi 2',
    ...
    let nav = `
        <div id="sliderNav" class="sliderNav">
            <div id="sliderPrev" class="sliderPrev" onclick="prevSlide(slider1, 'slider1');">
                <img width="32" height="32" src="Home/slide_dhh_1_0_0/images/left-arrow.svg" alt="left">
            </div>
            <div id="sliderNext" class="sliderNext" onclick="nextSlide(slider1, 'slider1');">
                <img width="32" height="32" src="Home/slide_dhh_1_0_0/images/right-arrow.svg" alt="right">
            </div>
        </div>
    `;
